...
# DEFUSE CHECK
execute as @e[type=minecraft:interaction,tag=shears_defuse_tnt,nbt={attack:{}}] on attacker if items entity @s weapon.mainhand minecraft:shears as @n[type=minecraft:interaction,tag=shears_defuse_tnt,nbt={attack:{}}] at @s run function shears_defuse_tnt:defuse
